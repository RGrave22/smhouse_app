...
class LocalDB {
  ...
  Future<void> insertDefaultUsers() async {
    ...
    AC kitchenAC = AC(acName: "kitchenAC", houseName: "user1:UsersHouse", divName: "user1:UsersHouse:kitchen", isOn: 0, acMode: "cool", acTimer: "0", swingModeOn: 0, airDirection: 0, acTemp: 0);
